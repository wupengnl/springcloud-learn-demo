package com.wu.springcloud.persistence.interceptor;


import com.wu.springcloud.persistence.Page;
import com.wu.springcloud.persistence.dialect.Dialect;
import com.wu.springcloud.xstream.Reflections;
...
public class SQLHelper {
    ...
    public static void main(String[] args) {
		String sql = "select id,(select id from a) from b";
		System.out.println("select count(1) " + removeSelect(removeOrders(sql)));
	}
}
